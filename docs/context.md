...
## Current Focus
- `splash-tui` now renders images in Ghostty + tmux using Kitty graphics placeholders, with character-cell rendering as fallback and graceful handling when `img_dir/` is missing.
